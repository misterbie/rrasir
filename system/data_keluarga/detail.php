...
if (isset($_POST['module'])) {
    ...
    if ($module == 'data_warga') {
        if (isset($_POST['kk']) && isset($_POST['ktp']) && isset($_POST['nama']) && isset($_POST['blok']) && isset($_POST['nomer']) && isset($_POST['tempat_lahir']) && isset($_POST['tgl_lahir']) && isset($_POST['kelamin1']) && isset($_POST['menikah1']) && isset($_POST['pendidikan1']) && isset($_POST['keluarga']) && isset($_POST['agama1']) && isset($_POST['pekerjaan']) && isset($_POST['telp']) && isset($_POST['status_rumah1']) && isset($_POST['alamat']) && isset($_POST['tabel_id'])) {
            ...
            $kelamin = $_REQUEST['kelamin1'];
            $menikah = $_REQUEST['menikah1'];
            $pendidikan = $_REQUEST['pendidikan1'];
            $keluarga = $_REQUEST['keluarga'];
            $agama = $_REQUEST['agama1'];
            $pekerjaan = $_REQUEST['pekerjaan'];
            $telp = $_REQUEST['telp'];
            $status_rumah = $_REQUEST['status_rumah1'];
